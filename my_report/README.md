...
-Play : παιζεις το παιχνίδι

-Help: βοηθεια με το πως παιζεται το παιχνίδι 

-Music: οn / off (δεν το εχω υλοποιήσει )

-Quit: να βγαινει απο το παιχνιδι (δεν το εχω υλοποιήσει )

-Level 1 : σε παει στην πρώτη πίστα 

-Level 2 :σε παει στην δεύτερη πίστα 
